    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> StudentRegister(StudentRegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                var user = new ApplicationUser { UserName = model.student.firstName, Email = model.Email, role="student" };
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> TeacherRegister(TeacherRegisterViewModel model)
        {
            if (ModelState.IsValid)
            {

                var user = new ApplicationUser { UserName = model.teacher.firstName, Email = model.Email, role = "teacher" };
